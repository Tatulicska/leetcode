...
//	String b = "456";
	...
	private static StringBuilder sumResults(ArrayList<ArrayList<Integer>> results) {
	...
	private static ArrayList<Integer> multiplyOneDigit(StringBuilder firstNumber, char secondNumberDigit, int numZeros) {
